// ======================================================================
// dcsd.v generated from TopDesign.cysch
// 01/24/2017 at 02:20
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=false, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QDEC, CY_INSTANCE_SHORT_NAME=QDEC, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=QDEC, )
...
module top ;
	...
	wire [0:0] tmpOE__phase_net;
	wire [0:0] tmpFB_0__phase_net;
	wire [0:0] tmpIO_0__phase_net;
	wire [0:0] tmpINTERRUPT_0__phase_net;
	electrical [0:0] tmpSIOVREF__phase_net;
	...
	cy_psoc3_pins_v1_10
		...
		phase
		 (.oe(tmpOE__phase_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__phase_net[0:0]}),
		  .io({tmpIO_0__phase_net[0:0]}),
		  .siovref(tmpSIOVREF__phase_net),
		  .interrupt({tmpINTERRUPT_0__phase_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__phase_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__sleep_net;
	wire [0:0] tmpFB_0__sleep_net;
	wire [0:0] tmpIO_0__sleep_net;
	wire [0:0] tmpINTERRUPT_0__sleep_net;
	electrical [0:0] tmpSIOVREF__sleep_net;
	...
	cy_psoc3_pins_v1_10
		...
		sleep
		 (.oe(tmpOE__sleep_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sleep_net[0:0]}),
		  .io({tmpIO_0__sleep_net[0:0]}),
		  .siovref(tmpSIOVREF__sleep_net),
		  .interrupt({tmpINTERRUPT_0__sleep_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sleep_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ovc_net;
	wire [0:0] tmpFB_0__ovc_net;
	wire [0:0] tmpIO_0__ovc_net;
	wire [0:0] tmpINTERRUPT_0__ovc_net;
	electrical [0:0] tmpSIOVREF__ovc_net;
	...
	cy_psoc3_pins_v1_10
		...
		ovc
		 (.oe(tmpOE__ovc_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ovc_net[0:0]}),
		  .io({tmpIO_0__ovc_net[0:0]}),
		  .siovref(tmpSIOVREF__ovc_net),
		  .interrupt({tmpINTERRUPT_0__ovc_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ovc_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__isense_net;
	wire [0:0] tmpFB_0__isense_net;
	wire [0:0] tmpIO_0__isense_net;
	wire [0:0] tmpINTERRUPT_0__isense_net;
	electrical [0:0] tmpSIOVREF__isense_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("492f915c-be62-4cf4-b9cf-23e7b059dad7"),
		  ...
		  .input_buffer_sel(2'b00))
		isense
		 (.oe(tmpOE__isense_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__isense_net[0:0]}),
		  .analog({Net_9208}),
		  .io({tmpIO_0__isense_net[0:0]}),
		  .siovref(tmpSIOVREF__isense_net),
		  .interrupt({tmpINTERRUPT_0__isense_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__isense_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_isr_v1_0
		#(.int_type(2'b10))
		rxISR
		 (.int_signal(Net_12386));


    TCPWM_P4_v2_10_5 TX_SEND (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
